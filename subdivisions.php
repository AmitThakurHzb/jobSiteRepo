        ...
        <div id="body" class="subdivisions">
            <ul>
                <li>
                    ...
                    <a href="blog.php"><img src="images/subdivision1.png" alt=""></a>
                </li>
                <li>
                    <div>
                    ...
                    <a href="blog.php"><img src="images/subdivision2.png" alt=""></a>
                </li>
                <li>
                    <div>
                        <h3>This is just a place holder</h3>
                    ...
                    <a href="blog.php"><img src="images/subdivision3.png" alt=""></a>
                </li>
                <li>
                    <div>
                        <h3>This is just a place holder</h3>
                    ...
                    <a href="blog.php"><img src="images/subdivision4.png" alt=""></a>
                </li>
            </ul>
        </div>
        <!--<div id="footer">-->
